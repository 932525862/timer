      ...
      <div className="container">
        <div className="w-full text-center ">
          <h4 className="text-[28px] sm:text-[35px] font-[700]">
            {i18n.language === "uz" ? (
              ...
              <>
                {t("afza.title")} <span className="nuqun text-[30px] sm:text-[45px] ">elesson</span>
              </>
            )}
          </h4>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-[30px] sm:mt-[50px]">
          <div className="grid grid-cols-2 items-center bg-[#fff] rounded-[15px]">
            <div className=" rounded-l-[15px] flex justify-center items-center text-[#fff]">
              <img
                src={afza1}
                alt="afza gif"
                className="w-full h-full rounded-l-[15px]"
              />
            </div>
            <div className="items-center p-[10px] sm:p-[20px] h-full flex flex-col justify-center">
              <h5 className="text-[16px] sm:text-[25px] font-[700] text-left w-full">
                {t("afza.afza1")}
              </h5>
